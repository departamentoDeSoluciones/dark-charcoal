...
vim.api.nvim_create_autocmd({ "BufWinEnter", "WinEnter" }, {
  ...
  callback = function(args)
    ...
    local win = vim.api.nvim_get_current_win()
    vim.wo[win].winhighlight = "Normal:SolidEditor,NormalNC:SolidEditor,SignColumn:SolidEditor,EndOfBuffer:SolidEditor"
  end,
})
...
function M.setup(user_config)
  ...
  hl("@keyword.conditional.ternary", { fg = p.keyword })
