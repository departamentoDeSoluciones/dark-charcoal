...
function M.setup(user_config)
  ...
  hl("NormalFloat",  { fg = p.fg, bg = p.cursorline })
  hl("FloatBorder",  { fg = p.inactive, bg = p.cursorline })
  ...
  hl("DiagnosticVirtualTextError", { fg = p.error, bg = p.cursorline })
  hl("DiagnosticVirtualTextWarn",  { fg = p.warning, bg = p.cursorline })
  hl("DiagnosticVirtualTextInfo",  { fg = p.info, bg = p.cursorline })
  hl("DiagnosticVirtualTextHint",  { fg = p.hint, bg = p.cursorline })
  ...
  hl("TelescopeNormal",        { fg = p.fg, bg = p.cursorline })
  hl("TelescopeBorder",        { fg = p.inactive, bg = p.cursorline })
  hl("TelescopePromptNormal",  { fg = p.fg, bg = p.cursorline })
  hl("TelescopePromptBorder",  { fg = p.inactive, bg = p.cursorline })
  ...
  hl("NeoTreeEndOfBuffer",   { fg = p.bg, bg = p.bg })
  hl("NeoTreeWinSeparator",  { fg = p.cursorline, bg = p.bg })
  ...
  hl("NvimTreeWinSeparator", { fg = p.cursorline, bg = p.bg })
  hl("NvimTreeFolderName",   { fg = p.func })
  hl("NvimTreeFolderIcon",   { fg = p.func })
  hl("NvimTreeOpenedFolderName", { fg = p.func })
  ...
  hl("MasonNormal",        { fg = p.fg, bg = p.cursorline })
  ...
  hl("lualine_c_normal",   { fg = p.fg, bg = p.cursorline })
  ...
  hl("TermNormal",      { fg = p.fg, bg = p.bg })
  hl("TermNormalNC",    { fg = p.fg, bg = p.bg })
  hl("ToggleTermNormal",{ fg = p.fg, bg = p.bg })
  hl("ToggleTermFloat", { fg = p.fg, bg = p.bg })
  hl("ToggleTermBorder",{ fg = p.inactive, bg = p.bg })
